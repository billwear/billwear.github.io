...
There were found by wartyping, which is the keyboard analogue of
[wardialing](https://en.wikipedia.org/wiki/Wardialing): typing
combinations of domain names, staring with \"a.org\" (e.g.) and working
up in the alphabet.

Skipped combinations either yield nothing, a parking page, a weird
religious site that buys up lots of empty domains, or a \"buy this
domain\" page. Here\'s my list so far:
...
- [u.org](https://u.org) - shortcut to understood.org, a neurodivergent
  support page\
...
- [cg.org](http://cg.org/) - common ground; sort of an in-between thing\
...
- [dh.org](https://dh.org) - doylestown health - not sure where this is\
...
- [dm.org](https://www.dm.org/) - a Christian campus ministry in
  Pennsylvania\
- [eh.org](http://eh.org/) - i have *no* idea, but it looks like an old
  BBS, sort of\
...
- [el.org](http://el.org/) - realnames: a more meaningful email address\
