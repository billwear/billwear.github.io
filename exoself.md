*The long version of a lightning talk I gave at a work sprint one time. In this case, a "sprint" is a week-long engineering meeting held twice a year, in a different, exotic city, somewhere in the world. A "lightning talk" is a timed five-minute talk on some subject of interest, given on stage at the end of the day, to other sprint participants.*
...
I am a true neutral, creative, diabetic, technical communicator. I choose these dimensions because they completely describe how I react to trauma, and how I can best manage my emotions when despair threatens.
By saying I am neutral, I mean I use intuition exactly as much as I use logic. I am neutral because I don't subscribe to dichotomies. I am creative because I think in pictures, animations, and scenarios. I am diabetic, which means I have a specific vulnerability to viruses -- and to interruptions in the supply chain -- which increase my concern in these interesting times. And I am a technical communicator because, to me, that's the area where I can do hard and difficult work and, hopefully, and with some reasonable humility, produce rare and valuable results.
...
An emacs "mode" is an editor overlay that changes the views and behaviors of a specific file type, but not other file types. You can have multiple files open, in multiple modes, all at the same time. Here I have one window open in directory mode; one in org-mode; one in chronos mode; one in lisp mode; and one in org-agenda mode.
Smart Outlining: The Writer's Excalibur

Org is a super-smart outline with folding. It also permits easy rearrangement, like a long outline section which moves easily regardless of how many sub-bullets you have. This is very handy for writing documents, since you can start with chaos and finish with organized thoughts.
...
Org has tables, like this insulin dosage sliding scale, which is a step function that can lead to constant over- and under-dosing. This can result in uneven blood sugar regulation, which often leads to 62% apathy among diabetics -- an apathy that has kicked up for me during these global crises. There are times I just want to eat chocolate, which is my personal kryptonite.
...
But, saving the day, these tables can also be used as spreadsheets, like this bolus calculator I was able to design. It uses a slope-intercept equation derived from a year's worth of personal blood sugar logs. I enter a blood-sugar reading, press a key chord, and I can dose precisely to the hundredths of a unit or smaller.
...
Org mode can graphically track anything I designate as a habit. For example, I can visually track how well I've done with various personal hygiene habits over the last few days.
...
My personal website project is entirely written in org-mode and exported as necessary to raw HTML or markdown.
...
Over time, this gives me the appearance of multitasking on several complex projects and keeping a lot of balls in the air, without dropping too many, which is not normal for someone with a neutral mind.
...
This is just one person's accommodation of his own mind. You have to adapt yourself to tools and needs, following a pattern like the one above, so that you can focus better and worry less. You can use almost the same tools and techniques with vim, nano, pico, Microsoft Word, Google Docs, or even pencil and paper. It's just a matter of (1) understanding your pain points, and (2) implementing specific patches that cover your weaknesses.

As an open-source developer advocate, technical author, and Canonical employee, I offer this little show and tell as just a bit of hope and encouragement. The ability to finish the day feeling good about what you've personally done -- regardless of how chaotic the world has been -- makes things just a little better.
