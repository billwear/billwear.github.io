...
<details>
	<summary>twisted concepts tucked in this code</summary>
	
here's a dissection of what `dayte` does, why it does it that way, and the backstory hidden in its twelve lines of shell code.
