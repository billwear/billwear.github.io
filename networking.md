...
between hosts, and very occasionally, we need to scan it to find network
breakage.
...
unit for a given layer -- *any* given layer. If we're talking about\
...
in the CDMA,\
noise-utilising transmission system that operates at that layer. My
advice? Unless you\'re a EE with some communications training, you might
